...
async def get_ads(client, advertiser_id: str, adgroup_id: Optional[str] = None, filters: Optional[Dict] = None, page: int = 1, page_size: int = 10, **kwargs) -> List[Dict[str, Any]]:
